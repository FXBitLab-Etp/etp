...
Etp Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 7899.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 7898 for connections and services them.
...
However, in open source software such as Etp Core, where everyone uses
...
pay attention to for reviewers of Etp Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Etp Core uses tinyformat, which is type safe. Leave them out to avoid confusion
