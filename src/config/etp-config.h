/* src/config/etp-config.h.  Generated from etp-config.h.in by configure.  */
/* src/config/etp-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "Etp Core 0.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "etpcore"
